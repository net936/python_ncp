...
class Thing(models.Model):
    ...
    pinzhong = models.CharField(max_length=50, blank=True, null=True)
    baozhiqi = models.CharField(max_length=100, blank=True, null=True)
    shengchanriqi = models.CharField(max_length=100, blank=True, null=True)
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
